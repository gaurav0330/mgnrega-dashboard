...
(async function main() {
  try {
    ...
    for (const [i, r] of records.entries()) {
      ...
      // Corrected field name + clamp between 0 and 100
      let payments =
        parseFloat(r['percentage_payments_generated_within_15_days'] ?? r['percentage_payments_gererated_within_15_days']) || 0;
